...
class QueueConsumer:
    def __init__(self):
        ...
        # Queue configuration
        self.input_queue = os.getenv('INPUT_QUEUE', 'all_data_queue')
    ...
    def setup_rabbitmq(self):
        ...
        try:
            ...
            # Declare queues
            self.rabbitmq_channel.queue_declare(queue=self.input_queue, durable=True)
    ...
    def start_consuming(self):
        ...
        try:
            logger.info(f"Starting to consume messages from {self.input_queue}")
